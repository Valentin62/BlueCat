...
class tpl_engine{
    ...
    public function output() {
         ...
         */
        if (!file_exists("Themes/".THEME."/templates/".$this->file)) {
            return "Error loading template file (Themes/".THEME."/templates/.$this->file).<br />";
            //$CORE->report_error("Impossible de charger la template (".$TPLName.".BlueCatTPL) dans le dossier: Themes/".THEME."/templates/", '');
        }
        $output = file_get_contents("Themes/".THEME."/templates/".$this->file);
    ...
    static public function merge($templates, $separator = "\n") {
        ...
        foreach ($templates as $template) {
            $content = (get_class($template) !== "tpl_engine")
